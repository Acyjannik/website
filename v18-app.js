(() => {
  ...
  function loadV186MobilePass() {
    if (document.getElementById('acy-v186-mobile-pass-script')) return;
    const script = document.createElement('script');
    script.id = 'acy-v186-mobile-pass-script';
    script.src = '/v18.6-mobile-pass.js?v=1865';
    script.defer = true;
    document.head.appendChild(script);
  }

  function loadV186StreamCenter() {
    if (document.getElementById('acy-v186-stream-center-script')) return;
    const script = document.createElement('script');
    script.id = 'acy-v186-stream-center-script';
    script.src = '/v18.6-stream-center.js?v=1866';
    script.defer = true;
    document.head.appendChild(script);
  }

  function loadV187StreamerEntry() {
    if (document.getElementById('acy-v187-streamer-entry-script')) return;
    const script = document.createElement('script');
    script.id = 'acy-v187-streamer-entry-script';
    script.src = '/v18.7-streamer-entry.js?v=1870';
    script.defer = true;
    document.head.appendChild(script);
  }
  ...
  function initMoreSheet() {
    ...
    sheet.addEventListener('click',(event)=>{const closeTarget=event.target.closest('[data-close-more]');if(closeTarget)close();const notificationTarget=event.target.closest('[data-open-notifications-v181]');if(notificationTarget){close();openNotifications();}});
