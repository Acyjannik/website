(() => {
  ...
  function getSupabaseAccessToken() {
    try {
      ...
      console.warn('[V18.2] Could not read auth session:', error);
    }
    return null;
  }
  ...
  async function handleNotificationAction(action, button) {
    ...
    try {
      ...
      console.warn(`[V18.2] Notification action ${action} failed:`, error);
  ...
  function injectNotificationMobileFixes() {
    ...
    style.textContent = `
      ...
      @media (max-width: 700px) {
        ...
        #notification-panel .notification-panel-head {
          position: sticky !important;
          top: 0 !important;
          z-index: 4 !important;
          gap: 10px !important;
          flex-wrap: wrap !important;
          background: rgba(11,11,16,.96) !important;
          backdrop-filter: blur(18px) !important;
        }
        #notification-panel .notification-panel-head > strong {
          flex: 1 1 100% !important;
          font-size: 22px !important;
        }
        #notification-panel .notification-panel-actions {
          display: flex !important;
          width: 100% !important;
          gap: 8px !important;
        }
        #notification-panel .notification-panel-actions button {
          min-height: 42px !important;
          padding: 9px 13px !important;
          flex: 1 1 auto !important;
          touch-action: manipulation !important;
        }
        #notification-panel .notification-panel-actions #notification-close {
          flex: 0 0 44px !important;
          font-size: 22px !important;
        }
        #notification-panel .notification-filter-row {
          position: sticky !important;
          top: 96px !important;
          z-index: 3 !important;
          background: rgba(11,11,16,.94) !important;
        }
        #notification-panel #notifications-list { position: relative !important; z-index: 1 !important; }
        #notification-panel #notifications-list button { touch-action: manipulation !important; }
      }
    `;
