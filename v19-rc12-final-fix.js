...
(() => {
  ...
  function patchVersionBadge(){const badge=document.getElementById('acy-dev-version-badge');if(badge){badge.innerHTML='<i></i><span>V19.0.0 · RC13</span>';badge.dataset.acyFinalUx='RC13'}}
  function init(){ensureInstallHelp();patchInstallHelp();patchNotifications();patchPetRelease();patchVersionBadge();setTimeout(patchVersionBadge,500)}
