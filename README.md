...
## V11.2.3 — Friendship Management
- Accepted friend requests are now a fallback source for the Friends list.
- Missing mirrored friendship rows are repaired automatically.
...
## V15.8 · Push-Grüße + Versionskonsistenz
