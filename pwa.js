...
/* ACY V17.3: keep the active service worker stable so Push can work reliably. */
...
async function subscribeAcyPush(){
  ...
  const registration=await navigator.serviceWorker.register('/service-worker.js?v=17.3.0',{scope:'/'});
...
document.addEventListener('DOMContentLoaded',()=>{
  ...
  if('serviceWorker' in navigator)navigator.serviceWorker.register('/service-worker.js?v=17.3.0',{scope:'/'}).catch(()=>{});
