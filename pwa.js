...
async function subscribeAcyPush(){
  ...
  const registration=await navigator.serviceWorker.register('/service-worker.js?v=16.2.0',{scope:'/'});
...
document.addEventListener('DOMContentLoaded',()=>{
  ...
  if('serviceWorker' in navigator)navigator.serviceWorker.register('/service-worker.js?v=16.2.0',{scope:'/'}).catch(()=>{});
